...
def buy():
    ...
    if request.method == "GET":
        ...
        if not symbol:
            ...
            db.execute("INSERT INTO transactions (user_id, symbol, shares, price, cash_before, cash_spent, cash_after, date_time, transaction_type) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)", user_id, symbol, shares, price, cash_before, cash_spent, cash_after, date_time, transaction_type)
