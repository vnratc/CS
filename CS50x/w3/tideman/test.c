...
// preferences[i][j] is number of voters who prefer 'i' over 'j'. This is a candiddates by candidates (candidate_count * candidate_count) matrix (2D array).
...
int main(int argc, string argv[])
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        ...
        {
            printf("Voter's ranks[] array: %i ", ranks[k]);
        }
        printf("\n");
