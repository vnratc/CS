...
async function load_mailbox(mailbox) {
    ...
    document.querySelector('#emails-view').style.animation = 'none';
    document.querySelector('#emails-view').offsetHeight;
    document.querySelector('#emails-view').style.animation = null;
